            ...
            <div class="card id-card mx-auto" data-aos="fade-left">
                <div class="row no-gutters">
                    <div class="col-md-4 text-center bg-light">
                        <img src="./asset/img/principal.jpg" class="id-card-img" alt="Person's Photo">
                        <h4 class="id-card-name mt-3">Dr. M. V. Bhatkar</h4>
                        <p class="id-card-post">&nbsp;Principal, Principal Of JIT Nashik</p>
                    </div>
                    <div class="col-md-8">
                        <div class="id-card-body">
                            <h5 class="id-card-title">Principal Details</h5>
                            <p class="id-card-text"><strong>Designation:</strong> Principal</p>
                            <p class="id-card-text"><strong>Qualification:</strong> Ph. D. M.Tech</p>
                            <p class="id-card-text"><strong>Total Experience:</strong> 34 Yrs</p>
                            <p class="id-card-text"><strong>Paper Published:</strong> National:05, International Journal:17</p>
                            <p class="id-card-text"><strong>Conference :</strong> 15</p>
                            <p class="id-card-text"><strong>Blog:</strong> <a href="https://principaljitnashik@gmail.com/" target="_blank">principaljitnashik@gmail.com</a></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container7">
            <div class="card" data-aos="fade-right">
                <div class="message-card-header text-center">
                    Message from the Principal of JIT Nashik
                </div>
