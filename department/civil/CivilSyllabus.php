...
document.addEventListener('DOMContentLoaded', function() {
        const items = [
            { title: "Syllabus of S.E. Civil", link: "civilcontent/SE 2019 Patt.pdf" },
            { title: "Syllabus of T.E. Civil", link: "civilcontent/TE 2019 Patt.pdf" },
            { title: "Syllabus of B.E. Civil", link: "civilcontent/BE Syllabus 2019 Course.pdf" },
            { title: "S.E. Time Table", link: "civilcontent/Time Table 23-24 Sem-1.pdf" },
            { title: "T.B. Time Table", link: "civilcontent/Time Table 23-24 Sem-1.pdf" },
            { title: "B.E. Time Table", link: "civilcontent/Time Table 23-24 Sem-1.pdf" }
        ];
