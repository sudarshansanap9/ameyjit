    ...
    <?php include('civilsidebar.php') ?>
        <div class="main p-3 ">
            <div class="container my-5" data-aos="fade-left">
                <h3 class="text-center pb-3">Civil Departmental Academic Calendar</h3>
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
        ...
        { year: "2018-19", sem: "I and II", link: "civilcontent/Academic_Calendar-2018-19_Civil_Engg-Dept.pdf" },
        { year: "2017-18", sem: "I and II", link: "civilcontent/Academic_Calendar_2017-18_both_sem.pdf" },
        { year: "2016-17", sem: "I and II", link: "civilcontent/Academic_Calendar_2016-17_both_sem.pdf" }
        ];
