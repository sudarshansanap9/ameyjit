      ...
      <?php include('computersidebar.php') ?>
        <div class="main p-3 ">
            <div class="container my-5" data-aos="fade-left">
                <h3 class="text-center pb-3">Computer Departmental Academic Calendar</h3>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const calendars = [
            { year: "2022-23", sem: "I", link: "content/Dept A.C.A.Y.2022-23 SEM-I.pdf" },
        { year: "2021-22", sem: "II", link: "content/Dept A.C.A.Y.2021-22 SEM-II.pdf" },
        { year: "2021-22", sem: "I", link: "content/Dept A.C.A.Y.2021-22 SEM-I.pdf" },
        { year: "2020-21", sem: "II", link: "content/Dept A.C.A.Y.2020-21 SEM-II.pdf" },
        { year: "2020-21", sem: "I", link: "content/Dept A.C.A.Y.2020-21 SEM-I" },
        { year: "2019-20", sem: "II", link: "content/Dept A.C.A.Y.2019-20 SEM-II.pdf" },
        { year: "2019-20", sem: "I", link: "content/Academic_Calendar_2019-20_SEM-1.pdf" },
        { year: "2018-19", sem: "I", link: "content/Academic_Calendar_2018-19_SEM-1.pdf" },
        { year: "2017-18", sem: "II", link: "content/Academic_Calendar_2017-18_SEM-2.pdf" },
        { year: "2017-18", sem: "I", link: "content/Academic_Calendar_2017-18_SEM-1.pdf" }
        ];
                ...
                <div class="card">
                    ...
                    <div id="collapse${index}" class="collapse ${index === 0 ? 'show' : ''}" aria-labelledby="heading${index}" data-parent="#academic-calendar-accordion">
                        <div class="card-body">
                            ...
                            <a href="${calendar.link}" class="btn btn-primary">Download</a>
                        </div>
                    </div>
                </div>
            `;
