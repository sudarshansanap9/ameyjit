...
<?php include('../header.php') ?>
    ...
    <?php include('electricalsidebar.php') ?>
        <div class="main p-3 ">
            <div class="container my-5" data-aos="fade-left">
                <h3 class="text-center pb-3">Electrical Departmental Academic Calendar</h3>
    ...
    <script>
     document.addEventListener('DOMContentLoaded', function() {
            ...
            { year: "2019-20", sem: "I", link: "civilcontent/Academic_Calendar-2018-19_Civil_Engg-Dept.pdf" },
            { year: "2019-20", sem: "II", link: "civilcontent/Academic_Calendar_2017-18_both_sem.pdf" },
            { year: "2017-18", sem: "I", link: "civilcontent/Academic_Calendar_2016-17_both_sem.pdf" },
            { year: "2017-18", sem: "II", link: "civilcontent/Academic_Calendar_2016-17_both_sem.pdf" }
            ];
