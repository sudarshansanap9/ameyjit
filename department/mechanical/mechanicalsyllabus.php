...
<?php include('../header.php') ?>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
        const items = [
            { title: "Syllabus of S.E. Mechanical(2019 Course)", link: "civilcontent/SE 2019 Patt.pdf" },
            { title: "Syllabus of T.E. Mechanical (2019 Course)", link: "civilcontent/TE 2019 Patt.pdf" },
            { title: "Syllabus of S.E. Mechanical(2015 Course)", link: "civilcontent/BE Syllabus 2019 Course.pdf" },
            { title: "Syllabus of T.E. Mechanical (2015 Course)", link: "civilcontent/Time Table 23-24 Sem-1.pdf" },
            { title: "Syllabus of B.E. Mechanical (2015 Course)", link: "civilcontent/Time Table 23-24 Sem-1.pdf" },
            { title: "S.E., T.E. and B.E. 2022-2023 Sem-2 Time Table", link: "civilcontent/Time Table 23-24 Sem-1.pdf" },
            { title: "S.E., T.E. and B.E. 2022-2023 Sem-1 Time Table", link: "civilcontent/Time Table 23-24 Sem-1.pdf" },
            { title: "S.E., T.E. and B.E. 2021-2022 Sem-2 Time Table", link: "civilcontent/Time Table 23-24 Sem-1.pdf" }
        ];
                ...
                <div class="card">
                    ...
                    <div id="collapse${index}" class="collapse ${index === 0 ? 'show' : ''}" aria-labelledby="heading${index}" data-parent="#syllabus-timetable-accordion">
                        <div class="card-body">
                            ...
                            <a href="${item.link}" class="btn btn-primary" target=_blank download>Download</a>
                        </div>
                    </div>
                </div>
            `;
