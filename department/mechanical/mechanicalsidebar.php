<aside id="sidebar">
            <div class="d-flex">
                ...
                <div class="sidebar-logo">
                    ...
                    <a href="#">Mechanical Dapartment</a>
                </div>
            </div>
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a href="mechanicalstudent.php" class="sidebar-link">
                        <i class="fa-solid fa-users-viewfinder"></i>
                        <span>Student Corner</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="mechanicalcalendar.php" class="sidebar-link">
                        <i class="fa-regular fa-calendar-days"></i>
                        <span>Academic Calendar</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="mechanicalsyllabus.php" class="sidebar-link">
                        <i class="fa-regular fa-map"></i>
                        <span>Syllabus & Time Table</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="mechanicalprogram.php" class="sidebar-link">
                        <i class="fa-regular fa-file"></i>
                        <span>PEO/PSO</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="mechanicalpos.php" class="sidebar-link">
